...
{$ENDIF}                                                               {!!.52}
      ...
      function omSubValidateElements(oElem : TXpElement;
			...
			procedure SetIgnoreXMLVersion(bValue : Boolean);
      procedure SetKeepLF(bValue : Boolean);
    protected
...
{End !!.51}
			...
			property IgnoreXMLVersion : Boolean read omIgnoreXMLVersion write SetIgnoreXMLVersion;
      property KeepLF : Boolean read omKeepLF write SetKeepLF;
  end;
...
{$ENDIF}                                                               {!!.52}
  ...
  omParser.IgnoreXMLVersion := omIgnoreXMLVersion;
  omParser.KeepLF := omKeepLF;
...
{--------}
procedure TXpObjModel.SetIgnoreXMLVersion(bValue : Boolean);
begin
	omIgnoreXMLVersion := bValue;
	if Assigned(omParser) then
		omParser.IgnoreXMLVersion := omIgnoreXMLVersion;
end;
{--------}
procedure TXpObjModel.SetKeepLF(bValue : Boolean);
begin
	omKeepLF := bValue;
	if Assigned(omParser) then
		omParser.KeepLF := omKeepLF;
