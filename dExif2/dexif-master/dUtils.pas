...
// Note: In dexifwrite line 298 the first item of ASubIFDList is deleted.
// TList.Delete does not free the memory.
// Since ASubIFDList is not a TList, but a TInt64List (dUtils, line 24),
// the procedure Notify must be overridden to prevent the memory leak.
// See: https://github.com/cutec-chris/dexif/issues/11
